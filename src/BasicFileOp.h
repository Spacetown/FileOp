...
# include "Types.h"
 ...
 extern tResult copySingleFile(LPCTSTR currentSourcePath, LPCTSTR currentTargetPath, tResult force);
 extern tResult moveSingleFile(LPCTSTR currentSourcePath, LPCTSTR currentTargetPath, tResult force);
 extern tResult touchSingleFile(LPCTSTR currentPath, LPCTSTR localTime, tResult createIfMissing);
