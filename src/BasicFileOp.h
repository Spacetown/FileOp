...
extern tResult copySingleFile(LPCTSTR currentSourcePath,
                              LPCTSTR currentTargetPath, tBool force);
extern tResult moveSingleFile(LPCTSTR currentSourcePath,
                              LPCTSTR currentTargetPath, tBool force);
...
extern tResult runCommandForEachInputLine(int argc, wchar_t *argv[],
