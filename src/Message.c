 ...
 */
tBool printError(LPCTSTR MsgTxt, ...)
{
   va_list vl;
   va_start(vl, MsgTxt);
 ...
 *
 * @param MsgTxt
 * @return VALUE_TRUE if no error is set, else VALUE_FALSE.
 */
